...
import {PIScaledPerSecondCalculator} from '../../validator/PIScaledPerSecondCalculator.sol';
...
contract PIScaledPerSecondCalculatorTest is DSTest {
    ...
    PIScaledPerSecondCalculator validator;
    Feed orcl;
    ...
    function setUp() public {
      ...
      validator = new PIScaledPerSecondCalculator(
        Kp,
        Ki,
